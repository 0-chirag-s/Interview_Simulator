        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
          ...
          <div className="p-6">
            ...
            {step === 2 && (
              ...
              >
                <div>
                  <h2 className="text-2xl font-bold text-gray-900">Choose Your Interviewer</h2>
                  <p className="text-gray-600 mt-1">Select an interviewer that matches your job industry.</p>
                </div>
                ...
                <div className="mt-4 text-center">
                  <p className="text-gray-600 text-sm">
                    Don't see an interviewer you like? We'll generate a custom interviewer for you.
                  </p>
                </div>
              </motion.div>
            )}
